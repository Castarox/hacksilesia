        ...
        data.forEach(function (track) {
            ...
            $.ajax({
                ...
                success: function (googleObj) {
                    ...
                    // console.log(googleObj.results);
                    var marker_location = googleObj.results[0].geometry.location;
                    var lat = marker_location.lat;
                    var lng = marker_location.lng;
                    // console.log(googleObj.results[1].geometry);
                    // alert(googleObj.results[2]);
                    // console.log(address);
                    var contentString =
                    '<div id="content">'+
                    '<div id="siteNotice">'+
